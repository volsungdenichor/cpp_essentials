#ifndef CPP_ESSENTIALS_SQ_DETAIL_FLATTEN_ITERATOR_HPP_
#define CPP_ESSENTIALS_SQ_DETAIL_FLATTEN_ITERATOR_HPP_
...
#endif /* CPP_ESSENTIALS_SQ_DETAIL_FLATTEN_ITERATOR_HPP_ */
