#ifndef CPP_ESSENTIALS_CORE_DETAIL_ZIP_ITERATOR_HPP_
#define CPP_ESSENTIALS_CORE_DETAIL_ZIP_ITERATOR_HPP_
...
#endif /* CPP_ESSENTIALS_CORE_DETAIL_ZIP_ITERATOR_HPP_ */
