...
{
    std::vector<int> vect{ 1, 2, 3, 4, 5, 6 };
    std::vector<int> result = vect | sq::take_while([](auto&& x) { return x < 4; });
...
{
    std::vector<int> vect{ 1, 2, 3, 4, 5, 6 };
    std::vector<int> result = vect | sq::drop_while([](auto&& x) { return x < 4; });
    REQUIRE(result == vec(4, 5, 6));
}

TEST_CASE("take_until")
{
    std::vector<int> vect{ 1, 2, 3, 4, 5, 6 };
    std::vector<int> result = vect | sq::take_until([](auto&& x) { return x == 4; });
    REQUIRE(result == vec(1, 2, 3));
}
...
{
    std::vector<int> vect{ 1, 2, 3, 4, 5, 6 };
    std::vector<int> result = vect | sq::drop_until([](auto&& x) { return x == 4; });
    REQUIRE(result == vec(4, 5, 6));
}
