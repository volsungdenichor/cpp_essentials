#ifndef CPP_ESSENTIALS_GEO_DETAIL_MATRIX_BASE_HPP_
#define CPP_ESSENTIALS_GEO_DETAIL_MATRIX_BASE_HPP_
...
public:
    ...
    template <size_type Index, size_type Row = R, CONCEPT = std::enable_if_t<(Row == 1 && Index < C)>>
    ...
    template <size_type Row = R, size_type Col = C, CONCEPT = std::enable_if_t<(Row == 1 && Col >= 1)>>
    ...
    template <size_type Row = R, size_type Col = C, CONCEPT = std::enable_if_t<(Row == 1 && Col >= 2)>>
    ...
    template <size_type Row = R, size_type Col = C, CONCEPT = std::enable_if_t<(Row == 1 && Col >= 3)>>
...
template <class T, std::size_t D>
struct tuple_size<::cpp_essentials::geo::vector<T, D>> : std::integral_constant<std::size_t, D> {};

template <std::size_t Index, class T, std::size_t D>
struct tuple_element<Index, ::cpp_essentials::geo::vector<T, D>>
{
    using type = decltype(std::declval<::cpp_essentials::geo::vector<T, D>>().template get<Index>());
};

} /* namespace std */

#endif /* CPP_ESSENTIALS_GEO_DETAIL_MATRIX_BASE_HPP_ */
