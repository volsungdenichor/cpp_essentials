#ifndef CPP_ESSENTIALS_CORE_DETAIL_CHAIN_ITERATOR_HPP_
#define CPP_ESSENTIALS_CORE_DETAIL_CHAIN_ITERATOR_HPP_
...
#endif /* CPP_ESSENTIALS_CORE_DETAIL_CHAIN_ITERATOR_HPP_ */
