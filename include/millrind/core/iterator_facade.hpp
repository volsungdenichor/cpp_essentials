...
public:
    ...
    self_type& operator ++()
    {
        ...
        {
            static_assert(
                has_advance_v<self_type>,
                "iterator_facade: either inc() or advance() methods required");
    ...
    self_type& operator --()
    {
        ...
        else
        {
            static_assert(
                has_advance_v<self_type>,
                "iterator_facade: either dec() or advance() methods required");
    ...
    friend self_type& operator +=(self_type& it, D offset)
    {
        static_assert(
            has_advance_v<self_type>,
            "iterator_facade: advance() methods required");
    ...
    {
        static_assert(
            has_distance_to_v<self_type>,
            "iterator_facade: distance_to() method required");
    ...
    friend bool operator ==(const self_type& lhs, const self_type& rhs)
    {
        ...
        else
        {
            static_assert(
                has_distance_to_v<self_type>,
                "iterator_facade: either is_equal() or distance_to() method required");
    ...
    friend bool operator <(const self_type& lhs, const self_type& rhs)
    {
        ...
        else
        {
            static_assert(
                has_distance_to_v<self_type>,
                "iterator_facade: either is_less() or distance_to() method required");
...
#define CORE_ITERATOR_TRAIRS(iter)                                                                                  \
namespace std                                                                                                       \
{                                                                                                                   \
template <class... Args>                                                                                            \
struct iterator_traits<iter<Args...>> : ::millrind::core::iterator_traits<iter<Args...>> {};                        \
}                                                                                                                   \
